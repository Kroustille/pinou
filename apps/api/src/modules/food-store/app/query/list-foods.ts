...
export const listFoodsQuery = (): FoodEntity[] => {
  return [
    FoodEntity.create({ id: '67f96f49fbdd362833586669', name: 'Feuille de chêne' }),
    ...
    FoodEntity.create({ id: '67f96f59a1fb910386b1a991', name: 'Céleri branche' }),
    ...
    FoodEntity.create({ id: '680c186f469a801d8ef378b1', name: 'Salade frisée'}),
