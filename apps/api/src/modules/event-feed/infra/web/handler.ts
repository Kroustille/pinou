...
import { GetRabbitEventFeedEntry, GetRabbitEventFeedResponse } from '@pinou/event-feed'
import { RabbitFeedEntry } from '#modules/event-feed/domain/service'

export const getRabbitEventFeedHandler = async (req: Request, res: Response) => {
...
const buildResponse = (entries: RabbitFeedEntry[]): GetRabbitEventFeedResponse => {
